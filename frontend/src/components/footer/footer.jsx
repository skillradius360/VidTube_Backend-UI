  ...
  return (
    ...
    <nav className=' h-14 w-full flex justify-between backdrop-blur-sm bg-white/30 '>
        ...
        <div className="flex w-[40%] justify-around pt-4">
            <NavLink to='/' 
            className={({isActive})=> `${isActive?` text-pink-400 font-medium`:`text-pink-400}`}`}>Home</NavLink>
            <NavLink to='/login' 
            className={({isActive})=> `${isActive?` text-pink-400 font-medium`:`text-pink-400}`}`}>Login</NavLink>
            <NavLink to='/SignUp' 
            className={({isActive})=> `${isActive?` text-pink-400 font-medium`:`text-pink-400}`}`}>SignUp</NavLink>
